...
def getArgs():
    ...
    argparser.add_argument(
        ...
        type=str,
        dest="parents",
        help="show parents hierarchey of the CWE ID",
    )
    argparser.add_argument(
        "-c",
        "--children",
        ...
        type=str,
        dest="children",
        help="show children of the CWE ID",
    )
    argparser.add_argument(
        "-k",
        "--keyword",
        ...
        type=str,
        dest="keyword",
        help="search by the keyword",
    )
    argparser.add_argument(
        "-a", "--capec", action="store_true", dest="capec", help="use capec mode"
    )
    argparser.add_argument(
        "-u", "--cuue", action="store_true", dest="CuuuuuuE", help="use cuue mode"
    )
    argparser.add_argument(
        "-l", "--list", action="store_true", dest="list", help="list all items"
    )
...
def main():
    ...
    if not os.path.isfile(cwe_path):
        print(
            "CWE: Download https://cwe.mitre.org/data/xml/cwec_latest.xml.zip, then extract it as cwec.xml."
        )
        print(
            "CAPEC: Download https://capec.mitre.org/data/xml/capec_latest.xml, then place it as capec.xml."
        )
        sys.exit()
